          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-gray-700">{analysisData.metadata?.contact || '정보 없음'}</p>
              </div>
            </div>
            <div className="space-y-3">
              <div>
              ...
              <div>
                ...
                <p className="text-gray-700">{analysisData.metadata?.search_field || '정보 없음'}</p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-600">담당부서:</span>
                <p className="text-gray-700">{analysisData.metadata?.responsible_department || '정보 없음'}</p>
              </div>
              <div>
